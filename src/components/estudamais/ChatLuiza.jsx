      ...
      <div className="container">
        ...
        >
          <div className="flex justify-center mb-6">
            <img  alt="Avatar da Luiza, a IA da EstudaMais.tech, com fundo escuro" className="w-32 h-32 rounded-full border-4 border-estudamais-yellow shadow-lg" src="public/images/luiza-w-shades.png" />
          </div>
